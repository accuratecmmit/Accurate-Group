    ...
    <div className="space-y-4 text-left">
      ...
      <div className="pt-3 border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5">
          <button
            type="button"
            onClick={() => fillQuickAccount('accurateadmin', 'Admin#2026!')}
            className="text-left px-2 py-1.5 bg-slate-100 hover:bg-indigo-50 dark:bg-slate-800 dark:hover:bg-indigo-950/40 rounded-lg text-[10px] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 transition-colors"
          >
            <span className="font-bold block text-indigo-600 dark:text-indigo-400">Super Admin</span>
            accurateadmin
          </button>
          <button
            type="button"
            onClick={() => fillQuickAccount('itadmin', 'ItAdmin#2026!')}
            className="text-left px-2 py-1.5 bg-slate-100 hover:bg-indigo-50 dark:bg-slate-800 dark:hover:bg-indigo-950/40 rounded-lg text-[10px] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 transition-colors"
          >
            <span className="font-bold block text-blue-600 dark:text-blue-400">IT Admin</span>
            itadmin
          </button>
          <button
            type="button"
            onClick={() => fillQuickAccount('technician', 'Tech#2026!')}
            className="text-left px-2 py-1.5 bg-slate-100 hover:bg-indigo-50 dark:bg-slate-800 dark:hover:bg-indigo-950/40 rounded-lg text-[10px] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 transition-colors"
          >
            <span className="font-bold block text-teal-600 dark:text-teal-400">IT Technician</span>
            technician
          </button>
          <button
            type="button"
            onClick={() => fillQuickAccount('Rahul', 'Rahul#2026!')}
            className="text-left px-2 py-1.5 bg-slate-100 hover:bg-indigo-50 dark:bg-slate-800 dark:hover:bg-indigo-950/40 rounded-lg text-[10px] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 transition-colors"
          >
          ...
          <button
            type="button"
            onClick={() => fillQuickAccount('Ananya', 'Ananya#2026!')}
            className="text-left px-2 py-1.5 bg-slate-100 hover:bg-amber-50 dark:bg-slate-800 dark:hover:bg-amber-950/40 rounded-lg text-[10px] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 transition-colors"
          >
            <span className="font-bold block text-amber-600 dark:text-amber-400">Pending Review</span>
            Ananya
          </button>
          <button
            type="button"
            onClick={() => fillQuickAccount('Deepak', 'Temp#Deepak2026!')}
            className="text-left px-2 py-1.5 bg-slate-100 hover:bg-purple-50 dark:bg-slate-800 dark:hover:bg-purple-950/40 rounded-lg text-[10px] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 transition-colors"
          >
            <span className="font-bold block text-purple-600 dark:text-purple-400">Temp Password</span>
            Deepak (Must Change)
          </button>
        </div>
      </div>
